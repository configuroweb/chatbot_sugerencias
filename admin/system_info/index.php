...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
		<div class="card-header">
			<h5 class="card-title">Información de Sistema</h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>" readonly>
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Nombre Corto del Sistema</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>" readonly>
				</div>
				<!-- <div class="form-group">
            ...
            < ?php endif; ?> -->
				<fieldset>
					<legend>Configuración de ChatBot con Sugerencias</legend>
					<div class="form-group">
						<label for="" class="control-label">Nombre Aplicación</label>
						<input name="bot_name" id="" cols="30" class="form-control" value="<?= $_settings->info('bot_name') ?>" readonly>
					</div>
					<div class="form-group">
						<label for="" class="control-label">Mensaje de Bienvenida</label>
						<textarea name="welcome_message" id="" cols="30" rows="2" class="form-control summernote"><?= $_settings->info('welcome_message') ?></textarea>
					</div>
					<div class="form-group">
						<label for="" class="control-label">Respuesta a Consulta Indefinida</label>
